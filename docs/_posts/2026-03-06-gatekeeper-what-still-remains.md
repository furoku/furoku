...
image: /assets/images/gatekeeper-what-still-remains/hero.webp
---
...
![消せるものと残るもの]({{ "/assets/images/gatekeeper-what-still-remains/fig-01-movable-vs-residual.webp" | relative_url }})
...
![移行後の残骸掃除]({{ "/assets/images/gatekeeper-what-still-remains/fig-02-cleanup-sweep.webp" | relative_url }})
