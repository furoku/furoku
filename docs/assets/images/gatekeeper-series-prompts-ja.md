...
保存先:
- `docs/assets/images/gatekeeper-proxy-not-enough/hero.png`
- `docs/assets/images/gatekeeper-proxy-not-enough/fig-01-architecture.png`
- `docs/assets/images/gatekeeper-proxy-not-enough/fig-02-layered-defense.png`
...
保存先:
- `docs/assets/images/gatekeeper-mcp-api-capsules/hero.png`
- `docs/assets/images/gatekeeper-mcp-api-capsules/fig-01-auth-patterns.png`
- `docs/assets/images/gatekeeper-mcp-api-capsules/fig-02-scoped-keys.png`
...
保存先:
- `docs/assets/images/gatekeeper-what-still-remains/hero.png`
- `docs/assets/images/gatekeeper-what-still-remains/fig-01-movable-vs-residual.png`
- `docs/assets/images/gatekeeper-what-still-remains/fig-02-cleanup-sweep.png`
...
### fig-01-movable-vs-residual.png
```text
