...
- 🖼️ **banana-infograph** - X投稿からインフォグラフィックを自動生成、最大4枚同時＆多言語対応（非公開リポジトリ化）
...
![GitHub Contribution Graph](https://ghchart.rshah.org/furoku)

---

## What I'm Doing

- **Data Marketing** - GA4 & GCP を活用したデータドリブンなマーケティング
- **AI-driven Solutions** - Gemini をはじめとする生成AIの活用推進
- **Workshop Design** - ファシリテーションとアイデア創出のワークショップ設計
- **Full Remote** - フルリモートワークスタイル
